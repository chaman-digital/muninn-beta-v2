...
def convert_pdf_to_markdown(filepath):
    ...
    try:
        ...
        # Usamos gemini-pro-latest según el requerimiento para mejor razonamiento sobre leyes extensas
        print("Solicitando conversión a Markdown usando Gemini...")
